...
(function () {
   ...
   */
  function setupLongPress(btn, { onLongPress, onTap }, timers) {
    let pressTimer = null;
   ...
   */
  function withCooldown(fn, delayMs = 500) {
    let active = false;
  ...
  function logEvent(hass, dog, eventType, extra = {}) {
  ...
  function deleteEvent(hass, eventId) {
    return hass.callService('pawsistant', 'delete_event', {
      event_id: eventId,
    });
  }

  function setShownTypes(hass, dog, shownTypes) {
